...
type GetLicenseDell struct {
	...
	LicenseInfoURI     string `json:"LicenseInfoURI"`
...
// BiosAttrHP is an alias for BiosDataHP for backward compatibility.
// It represents the raw Bios Settings from the Redfish API.
type BiosAttrHP = BiosDataHP
